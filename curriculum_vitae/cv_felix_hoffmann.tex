...
\begin{minipage}[t]{0.275\textwidth} % 27.5% of the page width for the first row of icons
	...
	\icon{At}{12}{\href{mailto:post@felixemmanuel.de}{post@felixemmanuel.de}}\\
\end{minipage}
\begin{minipage}[t]{0.275\textwidth} % 27.5% of the page width for the second row of icons
	...
	\icon{Github}{12}{\href{https://github.com/felixhoffmnn}{github.com/felixhoffmnn}}\\
	\icon{Twitter}{12}{\href{https://twitter.com/felixhoffmnn}{@felixhoffmnn}}\\
\end{minipage}
